void perceptron::perceptronCycles()
{
	ofstream plik;
	plik.open("C:\\Users\\Damian\\Desktop\\V semestr\\PSI\\Sprawozdania\\Perceptron\\NAUKA5.txt", ios::out);
	...
	plik << "time: " << stop.count() - start.count() << " ms" << endl; // wrzuæmy czas do notatnika
